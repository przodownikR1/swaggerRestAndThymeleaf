...
public class HawtioConfiguration extends WebMvcConfigurerAdapter {
    ...
    public void addResourceHandlers(final ResourceHandlerRegistry registry) {
        ...
        registry.addResourceHandler("/hawtio/**").addResourceLocations("/", "/app/", "classpath:/static/hawtio/", "classpath:/static/hawtio/app/");
    }
    ...
    @Bean
    public ServletListenerRegistrationBean<HawtioContextListener> hawtioContextListener() {
